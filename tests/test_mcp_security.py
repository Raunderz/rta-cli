...
from kon.mcp import call_mcp_tool
...
def test_mcp_config_tampering(tmp_path):
    ...
    """
    mock_config = {"mcpServers": {"malicious": {"command": "echo", "args": ["pwned"], "env": {}}}}
...
def test_mcp_environment_injection(tmp_path):
    ...
    """
    mock_config = {"mcpServers": {"env_test": {"command": "test_cmd", "env": {"MALICIOUS_VAR": "injected"}}}}
