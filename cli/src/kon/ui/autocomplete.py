...
DEFAULT_COMMANDS = [
    ...
    SlashCommand("whoami", "show current RTA user info"),
    SlashCommand("status", "show RTA backend usage stats"),
    SlashCommand("init", "initialize a new project", submit_on_select=False),
