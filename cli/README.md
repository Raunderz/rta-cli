...
> **Note: Rta CLI has moved to Kon.**
> After several iterations on our original CLI (`cli/`) and a solid v0.5.0 launch, we made the decision to shift to a fork of Kon
> ([https://github.com/0xku/kon](https://github.com/0xku/kon)) to maintain stability and code quality. Kon's clean architecture,
> modular tool system, and test coverage make it a stronger foundation going forward. Our extra tools (memory, sequential thinking,
> LSP, deep search, etc.) are being ported into this fork. See [`plan.md`](plan.md) for the full porting roadmap.
